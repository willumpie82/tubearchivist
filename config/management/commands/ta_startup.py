...
class Command(BaseCommand):
    ...
    def skip_migrations(self) -> bool:
        ...
        # Also check for underscore variant since dots in env var names don't work in shells
        env_var_alt = env_var.replace(".", "_")
        skipping = bool(os.environ.get(env_var) or os.environ.get(env_var_alt))
